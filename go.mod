...
require (
	github.com/ctylim/certificate-transparency-go v1.2.2 // indirect
	github.com/daedaleanai/ublox v0.0.0-20231229020953-163695469155 // indirect
	...
	modernc.org/ccgo/v4 v4.0.0-20230827202736-8661c3d9955b // indirect
