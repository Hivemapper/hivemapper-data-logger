...
func Test_CameraMountOrientation(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			acceleration:        NewAcceleration(0.5, 0.0, 1.0, -99, 0.0, time.Now()),
			expectedOrientation: OrientationFront,
		},
		{
			name:                "right side camera orientation",
			acceleration:        NewAcceleration(0.0, 0.5, 1.0, -99, 0.0, time.Now()),
		...
		},
		{
			...
			acceleration:        NewAcceleration(0.05, 0.0, 1.0, -99, 0.0, time.Now()),
		...
		},
		{
			...
			acceleration:        NewAcceleration(0.0, 0.05, 1.0, -99, 0.0, time.Now()),
			expectedOrientation: OrientationUnset,
		},
		{
