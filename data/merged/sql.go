...
type SqlWrapper struct {
	...
	correctedImuEvent *imu.CorrectedAccelerationEvent
	gnss              *gnss.GnssEvent
}

func NewSqlWrapper(imuRawEvent *imu.RawImuEvent, correctedImuEvent *imu.CorrectedAccelerationEvent, gnss *gnss.GnssEvent) *SqlWrapper {
	return &SqlWrapper{
